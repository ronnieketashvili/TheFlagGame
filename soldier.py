...
def soldier_moving():
    ...
    elif keys_pressed[pygame.K_UP] and soldier.y - consts.VEL > 0:
        soldier.y -= consts.VEL
    elif keys_pressed[pygame.K_LEFT] and soldier.x - consts.VEL > 0:
        soldier.x -= consts.VEL
    elif keys_pressed[pygame.K_DOWN] and soldier.y + consts.VEL + consts.SOLDIER_HEIGHT < BORDER.y:
        soldier.y += consts.VEL
