...
def soldier_in_matrix(minefield):
    ...
    soldier_location_matrix = minefield[int(soldier_row)][int(soldier_col)]
...
def checking_minefield():
    while soldier_in_matrix(consts.MINEFIELD) != 'mine' and soldier_in_matrix(consts.MINEFIELD) != 'flag':
        soldier_moving()
